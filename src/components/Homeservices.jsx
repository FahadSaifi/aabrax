...
import hw1 from "../assets/images/experience.webp";
import hw2 from "../assets/images/quality.webp";
import hw3 from "../assets/images/tag.webp";
      ...
      <div className="homeservices">
        ...
        <div className="card-warper">
          ...
          <div className="card">
            ...
            <p>
              Our conveyor systems are built to last, using high-quality
              materials and components, and are rigorously tested to deliver
